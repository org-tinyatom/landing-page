...
1. Describe the job and who will use the tool.
2. Build it with a coding assistant (Claude, Codex, Cursor, Gemini, or a local shell) inside TinyAtom Studio.
3. Review what files, data, and computer features the tool is asking to use.
4. Install it on one computer, or share it through a private company list.
...
Tools are shared through a public marketplace for community tools plus private company lists for internal ones. Submitted tools are reviewed for security problems and bugs before publication, as a best effort rather than a guarantee. Tools promoting gambling or adult content are not allowed.

Before installing anything, you see which files and computer features the tool is requesting, and you choose what it can open.
